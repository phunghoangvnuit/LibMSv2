...
namespace QuanLyThuVien.Models
{
    public class Sach
    {
        ...
        public double GiaThueTheoNgay { get; set; } = 0;
        ...
        public Sach(int iD_Sach, string tenSach, double giaTien, int soLuong, string urlImg, DateTime ngayNhap, double giaThue)
        {
            ID_Sach = iD_Sach;
            TenSach = tenSach;
            GiaTien = giaTien;
