    ...
    public class QuanLySachController : Controller
    {
        ...
        public IActionResult SearchSach(string? searchInput)
        {
            ...
            foreach (var item in dataSach)
            {
                ...
                var isSearch = item.sach.ID_Sach.ToString() == searchInput
                                ...
                                || item.tacGia.TenTacGia.ToUpper().Contains(searchInput.ToUpper())
                                || item.theLoai.TenTheLoai.ToUpper().Contains(searchInput.ToUpper());
                if(isSearch)
                {
        ...
        public LinkedList<InfoBook> getDataSach()
        {
            ...
            var dataSach = from s in _db.Saches
                           ...
                           select new
                           {
                               sach = new Sach(s.ID_Sach, s.TenSach, s.GiaTien, s.SoLuong, s.UrlImg, s.NgayNhap, s.GiaThueTheoNgay),
                               tacGia = new TacGia(tg.ID_TacGia, tg.TenTacGia, tg.QuocGia),
                               theLoai = new TheLoai(tl.ID_TheLoai, tl.TenTheLoai)
                           };
            ...
            foreach (var item in dataSach)
            {
                if (string.IsNullOrEmpty(item.sach.UrlImg))
                    item.sach.UrlImg = "/Images/Books/empty.png";
        ...
        public async Task<IActionResult> Create(InfoBook infoBook)
        {
            ...
            TheLoai obj = _db.TheLoais.Where(x => x.TenTheLoai.ToLower() == infoBook.TenTheLoai.ToLower())
                .FirstOrDefault();
            ...
            if (obj == null)
            {
                obj = new TheLoai()
                {
                    TenTheLoai = infoBook.TenTheLoai
                };
            ...
            if (isTg)
            {
                ...
                sach.GiaThueTheoNgay = infoBook.GiaThueTheoNgay;
                sach.SoLuong = infoBook.Sach.SoLuong;
                sach.UrlImg = infoBook.Sach.UrlImg;
                sach.NgayNhap = infoBook.Sach.NgayNhap;
                sach.ID_TacGia = idTacGia;
                sach.ID_TheLoai = obj.ID_TheLoai;
                // Thêm sách mới
                try
                {
        ...
        public IActionResult ViewEdit(int? id)
        {
            ...
            info.TenTheLoai = info.TheLoai.TenTheLoai;
        ...
        public async Task<IActionResult> EditPost(InfoBook info) 
        {
            try
            {
                ...
                TheLoai obj = _db.TheLoais.Where(x => x.TenTheLoai.ToLower() == info.TenTheLoai.ToLower())
                    .FirstOrDefault();
